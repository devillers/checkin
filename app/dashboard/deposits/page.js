    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-gray-600">
            Suivez vos deposits reçus et préparez vos futurs remboursements.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        >
          ...
          <div className="mt-4">
            <h2 className="text-lg font-semibold text-gray-900">Deposits perçus</h2>
            <p className="mt-2 text-gray-600 text-sm">
              Accédez au tableau de bord des deposits encaissés, filtrez par logement ou invité et suivez les
        ...
        <div className="card">
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h2 className="text-lg font-semibold text-gray-900">Gestion des deposits à venir</h2>
              <p className="mt-2 text-gray-600">
                Ce tableau de bord vous permettra bientôt de suivre les paiements, réclamations et remboursements
                liés aux deposits de vos locations.
              </p>
      ...
      <div className="card bg-primary-50 border-primary-100 text-primary-700">
        <div className="flex items-start space-x-3">
          ...
          <div>
            <h3 className="font-semibold">Sécurisez vos deposits avec Checkinly</h3>
